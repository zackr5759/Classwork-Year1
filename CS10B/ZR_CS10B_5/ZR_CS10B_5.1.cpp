...
int main() {
	...
	*p2 = x;
	...
	cout << "The adress of the first element is " << p2[0] << endl;
	...
	cout << "The adress of the second element is " << p2[1] << endl;
	...
	*p2 = temp;
	...
	cout << "The first element in a[] is " << a[0] << " and the second element in a[] is " << a[1] << endl;
